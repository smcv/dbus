 ...
 *
 * On platforms that do not support a system log, the mode is ignored and
 * the library behaves as though #DBUS_LOG_MODE_STDERR had been used.
 *
